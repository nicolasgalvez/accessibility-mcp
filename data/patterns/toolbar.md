...
id: "toolbar"
patternDocUrl: "https://www.w3.org/WAI/ARIA/apg/patterns/toolbar/"
---
...
*   If the toolbar has a visible label, it is referenced by [aria-labelledby](#aria-labelledby) on the toolbar element. Otherwise, the toolbar element has a label provided by [aria-label](#aria-label).
*   If the controls are arranged vertically, the toolbar element has [aria-orientation](#aria-orientation) set to `vertical`. The default orientation is horizontal.
