...
id: "radio"
patternDocUrl: "https://www.w3.org/WAI/ARIA/apg/patterns/radio/"
---
...
This section describes the keyboard interaction implemented for most radio groups. For the special case of a radio group nested inside a [toolbar](../toolbar/toolbar-pattern.html), use the keyboard interaction described in the following section.
...
*   If a radio button is checked, the `radio` element has [aria-checked](#aria-checked) set to `true`. If it is not checked, it has [aria-checked](#aria-checked) set to `false`.
